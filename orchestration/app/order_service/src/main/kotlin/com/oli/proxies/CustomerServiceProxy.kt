...
fun main() = runBlocking {
    println(CustomerServiceProxyImpl(RabbitMQConnectionManager.getInstance("localhost"), LoggerFactory.getLogger(CustomerServiceProxyImpl::class.java)).sendVerifyCustomerDetailsCommand(1, 1, Address(9123, "Mustertown", "2c")))
}
